...
For example, hovering over the element "Landings" in the full model shows that the working group identified the elements affected by landings as seafood production, recreational value, and profits (three links leading out from landings), and the elements affecting landings as Fluke SSB, distributional shifts, risk buffering, management control, discards, and fishery resilience (6 links leading into landings).
